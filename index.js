(() => {
  ...
  var background = Bodies.rectangle(240, 360, 480, 720, {
    isStatic: true,
  ...
  var ground = Bodies.rectangle(400, 1220, 810, 1000, {
    isStatic: true,
    render: { fillStyle: "transparent" },
  });
  var wallLeft = Bodies.rectangle(-50, 500, 100, 1000, {
    isStatic: true,
    render: { fillStyle: "transparent" },
  });
  var wallRight = Bodies.rectangle(530, 500, 100, 1000, {
    isStatic: true,
    render: { fillStyle: "transparent" },
  });
  ...
  function resize() {
    ...
    if (window.innerHeight / window.innerWidth >= 1.49) {
